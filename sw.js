const CACHE='football-manager-luxury-v2-section-isolated';
const ASSETS=['./','index.html','style.css?v=sectioniso1','app.js?v=sectioniso1','manifest.json?v=sectioniso1'];
