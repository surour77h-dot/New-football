const CACHE='football-rows24-compact-20260603-v1';
const ASSETS=['./','index.html','style.css?v=rows24compact20260603','app.js?v=rows24compact20260603','manifest.json?v=rows24compact20260603'];
