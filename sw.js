const CACHE='football-manager-luxury-v2-navigation-fixed';
const ASSETS=['./','index.html','style.css?v=fmpro2navfix','app.js?v=fmpro2navfix','manifest.json?v=fmpro2navfix'];
